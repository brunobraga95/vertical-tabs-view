...
export const GetTabFromID = (id) => document.getElementById("tab_wrapper_" + id);
...
export const GetFirstTabInfoWrapperElement = () => document.getElementsByClassName("tab-info-wrapper").length > 0 ? document.getElementsByClassName("tab-info-wrapper")[0] : null;